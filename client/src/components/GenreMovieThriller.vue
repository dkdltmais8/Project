...
<div class='black'>
  ...
  id="Show-btn" 
  @click.native="$bvModal.show('modal4'), chooseId=movie.id"
  ...
  <b-modal id="modal4" centered size="lg" hide-header-close>
...
export default {
  ...
  methods : {
    ...
    getMovie () {
      axios ({
        method:'get',
        url: 'https://api.themoviedb.org/3/movie/popular?api_key=33b865b38e340385996befbfd40fadd0&language=ko-KR&page=9',
      })
